...
新增：
1. 移除了不必要的权限。
2. 注册时用户名不允许使用中文和特殊字符。

## 4.9.15 - 2025/07/04
新增：
1. 集成Floo-android v4.5.0。
2. 发送相册中的视频。
3. 双击“对话”按钮定位到最近的未读会话。
4. 实名认证。
...
## 4.9.9 - 2025/04/29
新增：
1. 集成Floo-android v4.4.3。
2. 新的关于界面和登录注册界面。

## 4.8.21 - 2025/04/03
解决Bug：
1. android14及以上系统设置头像时获取权限失败。

## 4.8.19 - 2025/04/01
新增：
1. DNS服务器域名指定IP，避免域名污染。
...
## 4.5.0 - 2024/08/07
新增:
1. 集成Floo-android v4.2.3
2. App配置：隐藏群成员信息；禁止发送位置消息。
3. 适配android 14上相册访问。

## 4.4.2 - 2024/07/20
新增:
1. 集成Floo-android v4.2.2。
2. 群设置项：隐藏群成员信息。
