...
//import top.maxim.rtc.manager.UCloudRTCManager;
//
///**
// * Description 单视频会话
// */
...
//        mEngine = UCloudRTCManager.getInstance().getRTCEngine();
//        UCloudRTCManager.getInstance().addRtcListener(mListener = new BMXRTCEngineListener() {
//            @Override
...
//        leaveRoom();
//        mHandler.removeAll();
//        UCloudRTCManager.getInstance().removeRtcListener(mListener);
