//package top.maxim.im.rtc.webrtcmodule;
//
...
////        url.add("stun:stun.xten.com");
////        url.add("stun:23.21.150.121");
////        url.add("stun:stun.l.google.com:19302");
////        url.add("stun.softjoys.com:3478");
...
//                Peer peer = getOrCreateRtcConnect(from);
...
//     */
//    //创建并加入
//    public void createAndJoinRoom(String roomId, String userId) {
//        //构建信令数据并发送
//        try {
...
//            //向信令服务器发送信令
//            sendMessage("createAndJoin", message);
//        } catch (JSONException e) {
//            e.printStackTrace();
//        }
//    }
...
//     */
//    //构建webRtc连接并返回
//    private Peer getOrCreateRtcConnect(String from) {
//        Peer pc = peers.get(from);
//        if (pc == null) {
//            //构建RTCPeerConnection PeerConnection相关回调进入Peer中
//            pc = new Peer(from, factory, rtcConfig, WebRtcClient.this);
//            //设置本地数据流
...
//            Peer peer = getOrCreateRtcConnect(peerId);
//            peer.getPc().createOffer(peer, sdpMediaConstraints);
//        }
//    }
//
...
//            peer.getPc().createAnswer(peer, sdpMediaConstraints);
//        }
//    }
//
